...
export default function PagApp ({ navigation }){
  return(
    <>
    <View style={conteinerStyle.container}>
      <View style={conteinerStyle.header}>
        <Image style={{alignSelf: 'flex-start', height: 40, width: 280 ,resizeMode:'stretch' }} source={require('./images/pag_app.png')} />
      </View>

      <View style={conteinerStyle.body}>
        <Image style={imageStyles.imageCenter} source={require('./images/item_pag_app.png')} />
      ...
      <TouchableOpacity onPress={() => navigation.navigate('PagRealizado')} style={buttonStyle.buttonYellow}>
          <Text style={{color: 'black', fontSize: 20, alignSelf: 'center'}}>FINALIZAR COMPRA</Text>
      </TouchableOpacity>
    </View>
    </> 
