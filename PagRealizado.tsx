...
export default function PagRealizado({ navigation }){
  return(
    <>
    <View style={conteinerStyle.container}>
      <View style={conteinerStyle.header}>
        <Image style={{alignSelf: 'flex-start', height: 40, width: 300 ,resizeMode:'stretch' }} source={require('./images/pag_realizado.png')} />
      </View>

      <View style={conteinerStyle.body}>
        <Image style={imageStyles.imageCenter} source={require('./images/pagamento_realizado.png')} />
        <Text style={{fontSize: 20, textAlign: 'center', alignSelf:'flex-start', padding:30}}>
        Apresente o código acima em nosso check-out e retire seu pedido.
        </Text>
      </View>
